...
public class SellerTest {
    ...
    public void testInitialState() throws Exception {
        underTest = new Seller(SELLER_ID, asDate(LocalDate.now().minus(30, ChronoUnit.DAYS)));
    ...
    public void testPercentagePolicyIsAllowedForSeniors() throws Exception {
        underTest = new Seller(SELLER_ID, asDate(LocalDate.now().minus(Seller.SENIORITY_THRESHOLD, ChronoUnit.DAYS)));
        underTest.enablePercentageBonusPolicy();
    }
